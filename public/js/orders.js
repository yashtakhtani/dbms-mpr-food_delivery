...
const SORT_CFG = { idKey: 'order_id', nameKey: 'customer_name' };
const EXPORT_COLS = [
  { header: 'Order ID', key: 'order_id' },
  { header: 'Date', accessor: (o) => (o.order_date ? new Date(o.order_date).toLocaleDateString('en-IN') : '') },
  { header: 'Customer', accessor: (o) => o.customer_name || o.customer_id || '' },
  { header: 'Restaurant', accessor: (o) => o.restaurant_name || o.restaurant_id || '' },
  { header: 'Driver', accessor: (o) => o.driver_name || o.driver_id || '' },
