...
function renderTable() {
    ...
    <tr>
      ...
      <td class="actions">
        <button class="btn btn-secondary btn-sm" onclick="edit('${i.food_id || i.food_name}')"><i data-lucide="edit-2" style="width:14px"></i></button>
        <button class="btn btn-danger btn-sm" onclick="del('${i.food_id || i.food_name}')"><i data-lucide="trash-2" style="width:14px"></i></button>
      </td>
    </tr>
  `).join('');
